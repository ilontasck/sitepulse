...
const routes = new Set(["/api/health", "/api/ready", "/api/operations", "/api/audits", "/api/audits/quota", "/api/auth/config", "/api/auth/register", "/api/auth/login", "/api/auth/logout", "/api/auth/me"]);
