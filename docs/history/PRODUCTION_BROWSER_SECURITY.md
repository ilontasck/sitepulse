> Historical reference. For current commands and release status use [README](../../README.md), [local setup](../LOCAL-DEVELOPMENT.md) and [current status](../SOURCE-OF-TRUTH.md). Relative paths in the original text refer to the repository root.
